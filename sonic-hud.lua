...
local function create_main_hud(ly, w, h)
	...
	main_hud:add_status_icon(1,          2, ui_icons.score         , nil, game.get_score         , game)
	main_hud:add_status_icon(1,     ly + 2, ui_icons.clock         , nil, game.get_time          , game)
	main_hud:add_status_icon(1, 2 * ly + 2, ui_icons.ring          , nil, game.get_rings         , game)
	main_hud:add_status_icon(1, 3 * ly + 2, ui_icons.emeralds_chaos, nil, game.get_chaos_emeralds, game)
	if rom:is_sonic3k() then
		main_hud:add_status_icon(36, 3 * ly + 2, ui_icons.emeralds_super, nil, game.get_super_emeralds, game)
