...
sonic2_rom_data = {
	...
	y_vel = 0x12,
	inertia = 0x14,
	boss_invulnerable_time = 0x14,
	y_radius = 0x16,
	x_radius = 0x17,
	collision_property = 0x21,
	status = 0x22,
	angle = 0x26,
	air_left = 0x28,
	obj_control = 0x2a,
	Obj_Eggrobo_invulnerable_time = 0x2a,
	status_secondary = 0x2b,
	move_lock = 0x2e,
	invulnerable_time = 0x30,
	Obj_MechaSonic_invulnerable_time = 0x30,
	Obj_WFZBoss_invulnerable_time = 0x30,
	...
	air_frames = 0x38,
	Obj_CPZBoss_invulnerable_time = 0x3e,
	Obj_EHZBoss_invulnerable_time = 0x3e,
	object_size = 0x40,
	Player1 = 0xffb000,
	Player2 = 0xffb040,
	Dynamic_Object_RAM = 0xffb400,
	bubbles_P1 = 0xffd080,
	bubbles_P2 = 0xffd0c0,
	shield = 0xffd180,
	Dynamic_Object_RAM_End = 0xffd400,
	control_counter = 0xfff702,
	respawn_counter = 0xfff704,
	CPU_routine = 0xfff708,
	Player_option = 0xffff72,
	Two_player_mode = 0xffffd8,
	Two_player_items = 0xffff74,
	GameModeID_Demo = 0x8,
