...
--	Constructor.
function rom_info.create(checksum, engine, air_cap, tails_flies, cream_flies, get_char, boss_array, ring_offset, hud_code, is_rom)
	local self = ShallowCopy(rom_info, self)
...
local supported_games = {
	...
	s1wrev0  = rom_info.create(sums.s1wrev0  , eng.s1 , true , false, false, charids.sonic   , bosses.s1wrev0 , 0xfffe20),
	s1wrev1  = rom_info.create(sums.s1wrev1  , eng.s1 , true , false, false, charids.sonic   , bosses.s1wrev1 , 0xfffe20),
	s1knux   = rom_info.create(sums.s1knux   , eng.s1 , false, false, false, charids.knuckles, bosses.s1knux  , 0xfffe20),
	s1tails  = rom_info.create(sums.s1tails  , eng.s1 , false, true , false, charids.tails   , bosses.s1tails , 0xfffe20 , nil       , s1tails_check),
	s1amy    = rom_info.create(sums.s1amy    , eng.s1 , false, false, false, charids.amy_rose, bosses.s1amy   , 0xfffe20),
	s1charmy = rom_info.create(sums.s1charmy , eng.s1 , false, false, false, charids.charmy  , bosses.s1charmy, 0xfffe20),
	scd      = rom_info.create(sums.scd      , eng.scd, true , false, false, charids.sonic   , bosses.scd     , 0xff1512),
	s2       = rom_info.create(sums.s2       , eng.s2 , true , false, false, 0xffff72        , bosses.s2      , 0xfffe20, huds.s2    ),
	s2knux   = rom_info.create(sums.sk       , eng.s2 , false, false, false, charids.knuckles, bosses.s2knux  , 0xfffe20, huds.s2knux, sklockon_check(sums.s2)),
	s2amy    = rom_info.create(sums.s2amy    , eng.s2 , false, false, false, s2amy_char      , bosses.s2amy   , 0xfffe20, huds.s2amy ),
	s2boom   = rom_info.create(sums.s2boom   , eng.s2 , false, false, false, charids.sonic   , bosses.s2boom  , 0xfffe02, huds.s2boom),
	s2rob    = rom_info.create(sums.s2rob    , eng.s2 , true , false, false, 0xffff72        , bosses.s2rob   , 0xfffe20, huds.s2rob ),
	s2vr     = rom_info.create(sums.s2vr     , eng.s2 , true , false, false, charids.sonic   , bosses.s2      , 0xfffe02, huds.s2    ),
	s2hrtw   = rom_info.create(sums.s2hrtw   , eng.s2 , true , false, false, 0xffff72        , bosses.s2      , 0xfffe20, huds.s2    ),
	s1and2   = rom_info.create(sums.s1and2   , eng.s2 , true , false, false, 0xffff72        , bosses.s1and2  , 0xfffe20, huds.s1and2),
	s1and2b  = rom_info.create(sums.s1and2b  , eng.s2 , true , false, false, 0xffff72        , bosses.s1and2  , 0xfffe20, huds.s1and2),
	s3       = rom_info.create(sums.s3       , eng.s3 , false, true , false, 0xffff08        , bosses.s3      , 0xfffe20, huds.s3    ),
	sk       = rom_info.create(sums.sk       , eng.sk , false, true , false, 0xffff08        , bosses.sk      , 0xfffe20, huds.sk    , sknolockon_check),
	s3k      = rom_info.create(sums.sk       , eng.s3k, false, true , false, 0xffff08        , bosses.sk      , 0xfffe20, huds.sk    , sklockon_check(sums.s3)),
	s3kmaster= rom_info.create(sums.s3kmaster, eng.s3k, false, true , false, 0xffff08        , bosses.sk      , 0xfffe20, huds.sk    ),
	s3kamy   = rom_info.create(sums.s3kamy   , eng.s3k, false, true , false, s3kamy_char     , bosses.sk      , 0xfffe20, huds.s3kamy),
}
